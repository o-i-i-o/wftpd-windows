...
class FTPClient:
    ...
    def __init__(self, host, port, username, password, timeout=10):
        ...
        self.unique_prefix = f"ftp_{datetime.now().strftime('%Y%m%d_%H%M%S')}_"
    ...
    def run_all_tests(self):
        ...
        try:
            ...
            # 文件操作测试
            test_content = f"FTP 测试内容 - {datetime.now().isoformat()}"
...
def main():
    """主函数"""
    print("="*60)
    print("WFTPG 普通 FTP (非 SSL) 完整功能测试")
    print("测试用户：123 / 密码：123456")
    print("="*60)
    
    print("\n[INFO] 测试模式：PLAIN FTP (端口 2121)\n")
    ...
    result = ftp_client.run_all_tests()
